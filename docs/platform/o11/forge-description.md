...
4. For index-based actions (`List_Pop`, `List_PopMultiple`), serialize your `List of Text` (or any Record List) with `JSONSerialize` first — all nine actions consume and return JSON strings.
