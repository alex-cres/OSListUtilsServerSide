...
4. For index-based actions (`List_Pop`, `List_PopMultiple`), serialize your `List of Text` (or any Structure List) with `JSON Serialize` first — every action consumes and returns JSON strings.
